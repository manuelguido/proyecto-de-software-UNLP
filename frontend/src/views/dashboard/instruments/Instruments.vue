    ...
    loadInstruments () {
      ...
      for (let i = 0; i < this.instruments.length; i++) {
        newrow = {
          ...
          show: '<a href="' + this.showInstrumentPath + this.instruments[i].instrument_id + '" class="btn btn-primary btn-sm seed-rounded"><i class="far fa-eye mr-3"></i>Ver</a>',
          edit: '<a href="' + this.editInstrumentPath + this.instruments[i].instrument_id + '" class="btn btn-warning btn-sm seed-rounded"><i class="far fa-edit mr-3"></i>Editar</a>'
        }
