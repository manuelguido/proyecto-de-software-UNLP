    ...
    loadInstruments () {
      ...
      for (let i = 0; i < this.instruments.length; i++) {
        newrow = {
          ...
          edit: '<a href="' + this.editInstrumentPath + this.instruments[i].instrument_id + '" class="btn seed-btn-secondary btn-sm seed-rounded"><i class="fas fa-pencil-alt mr-3"></i>Editar</a>'
        }
